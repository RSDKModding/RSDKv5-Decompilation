...
// DummyCore simulates slower load times, remove these in the decomp
#if !RETRO_USE_ORIGINAL_CODE
#define SYSTEM_USERSTORAGE_TIME (0)
#define SYSTEM_LEADERBOARD_TIME (0)
#else
#define SYSTEM_USERSTORAGE_TIME (30)
#define SYSTEM_LEADERBOARD_TIME (120)
#endif
...
int32 GetAPIValue(uint32 id)
{
    switch (id) {
        ...
        case 0x4205582D: return SYSTEM_LEADERBOARD_TIME; // SYSTEM_LEADERBOARD_LOAD_TIME
        ...
        case 0xBDF4E94A: return SYSTEM_USERSTORAGE_TIME; // SYSTEM_USERSTORAGE_AUTH_TIME

        case 0xD77E98BE: return SYSTEM_USERSTORAGE_TIME; // SYSTEM_USERSTORAGE_STORAGE_INIT_TIME

        case 0x5AF715C2: return SYSTEM_USERSTORAGE_TIME; // SYSTEM_USERSTORAGE_STORAGE_LOAD_TIME

        case 0x54378EC5: return SYSTEM_USERSTORAGE_TIME; // SYSTEM_USERSTORAGE_STORAGE_SAVE_TIME

        case 0xCD44607D: return SYSTEM_USERSTORAGE_TIME; // SYSTEM_USERSTORAGE_STORAGE_DELETE_TIME
    }
